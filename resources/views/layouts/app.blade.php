            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        <li class="nav-item">
                            <a href="{{route('semua_sekolah')}}" class="nav-link active">Sekolah</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{route('semua_kelas')}}" class="nav-link active">Kelas</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{route('semua_siswa')}}" class="nav-link active">Siswa</a>
                        </li>
